...
import fachada.HistoricoFacade;
...
public class HistoricoController implements Serializable {
    ...
    @EJB
    private fachada.HistoricoFacade ejbFacade;
    ...
    public Historico getSelected() {
        if (current == null) {
            ...
            current.setHistoricoPK(new entidade.HistoricoPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoricoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoricoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HistoricoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class HistoricoControllerConverter implements Converter {
        ...
        entidade.HistoricoPK getKey(String value) {
            entidade.HistoricoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entidade.HistoricoPK();
            key.setIdGestao(Integer.parseInt(values[0]));
            key.setIdCargo(Integer.parseInt(values[1]));
            key.setIdFuncionario(Integer.parseInt(values[2]));
            return key;
        }

        String getStringKey(entidade.HistoricoPK value) {
            StringBuffer sb = new StringBuffer();
            sb.append(value.getIdGestao());
            sb.append(SEPARATOR);
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Historico) {
                ...
                return getStringKey(o.getHistoricoPK());
            } else {
